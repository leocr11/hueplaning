								...
								<div class="validation-grids widget-shadow" data-example-id="basic-forms"> 
									<div class="input-info">
										...
										<div class="float-md-left">
											<input type="button" class="btn btn-primary" value="Agregar" onclick="location.href = 'index.php?page=pDiaria&funcion=registro&step=1&id=<?php echo $row[0]?>';">	
											</div><br>
									</div>
										...
										<table class="table">
										  ...
										  <tbody>
										    ...
										    <tr>
										      ...
										      <td>
												   <input type="button" class="btn btn-danger" value="Editar" onclick="location.href = 'index.php?page=pDiaria&funcion=editar&step=1&id=<?php echo $row[0]?>';">
											  </td>
										    </tr>
											<?php } ?>
										  </tbody>
