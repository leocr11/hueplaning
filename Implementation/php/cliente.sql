...
INSERT INTO `usuario` (`id`, `dni`, `Nombre`, `Apellido`, `Correo`, `Telefono`) VALUES
...
--
DELIMITER $$
CREATE TRIGGER `editrigger` AFTER UPDATE ON `usuario` FOR EACH ROW INSERT INTO auditoria (Usuario_reg,Fecha_reg,dni_reg,Nombre_reg,Apellido_reg,Accion_reg,Correo_reg,Telefono_reg,NuevoCorreo_reg,NuevoNom_reg,NuevoApe_reg,NuevoTel_reg) VALUES (CURRENT_USER(),CURRENT_DATE (),new.dni,old.Nombre,old.Apellido,'3',old.correo,old.Telefono,new.correo,new.Nombre,new.Apellido,new.Telefono)
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `elim_trigger` BEFORE DELETE ON `usuario` FOR EACH ROW INSERT INTO auditoria(Usuario_reg,Fecha_reg,dni_reg,Nombre_reg,Apellido_reg,Correo_reg,Accion_reg,Telefono_reg) VALUES (CURRENT_USER(),CURRENT_DATE (),old.dni,old.Nombre,old.Apellido,old.Correo,'2',old.Telefono)
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `inserttrigger` AFTER INSERT ON `usuario` FOR EACH ROW INSERT INTO auditoria (Usuario_reg,Fecha_reg,dni_reg,Nombre_reg,Apellido_reg,Telefono_reg,Correo_reg,Accion_reg) VALUES (CURRENT_USER(),CURRENT_DATE (),new.dni,new.Nombre,new.Apellido,new.Telefono,new.Correo,'1')
$$
DELIMITER ;
