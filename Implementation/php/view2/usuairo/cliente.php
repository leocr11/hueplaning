...
name="Auditoria" 
size="1">
<option value="usuario/usuario.php" selected>Elija una accion de auditoria </option>
...
<table class="table  table-striped  table-hover" id="tabla">
    ...
    <?php foreach ($this->model->Listar() as $r): ?> 
        <tr>
            ...
            <td> <a class="btn btn-warning"href="?c=usuario&a=Crud&id=<?php echo $r->id; ?>">EDITAR</a> </td>
            <td> <a class="btn btn-danger"onclick="javascript : return confirm('Seguro que desea eliminar este usuario??');"  href="?c=usuario&a=Eliminar&id=<?php echo $r->id; ?>">ELIMINAR</a></td>
