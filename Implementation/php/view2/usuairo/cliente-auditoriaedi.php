<h1 class="page-header">REGISTROS EDITADOS</h1>
...
<option  value="?c=usuario&a=aud_insert">Registrados</option>
<option value="?c=usuario&a=aud_elim">Eliminados</option>
<option value="?c=usuario&a=aud_mod">Editados</option>
...
<table class="table  table-striped  table-hover" id="tabla">
    <thead>
        ...
        <th style="width:120px; background-color: #5DACCD; color:#fff">Id registro</th>
            ...
            <th style="width:60px; background-color: #5DACCD; color:#fff">Nuevo nombre</th>
            <th style="width:60px; background-color: #5DACCD; color:#fff">Nuevo apellido</th>
            <th style="width:60px; background-color: #5DACCD; color:#fff">Nuevo correo</th>
            <th style="width:60px; background-color: #5DACCD; color:#fff">Nuevo telefono</th>

        </tr>
    </thead>
    <tbody>
    <?php foreach ($this->model->List_aud_mod() as $r): ?> 
        <tr>
            ...
            <td><?php echo $r->Correo_reg; ?></td> 
             ...
             <td><?php echo $r->NuevoNom_reg; ?></td> 
             <td><?php echo $r->NuevoApe_reg; ?></td> 
             <td><?php echo $r->NuevoCorreo_reg; ?></td> 
             <td><?php echo $r->NuevoTel_reg; ?></td>    
